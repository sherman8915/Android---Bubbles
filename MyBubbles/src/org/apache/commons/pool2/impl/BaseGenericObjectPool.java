...
//##not compatible ### import java.lang.management.ManagementFactory;
...
//##not compatible ### import javax.management.InstanceAlreadyExistsException;
//##not compatible ### import javax.management.InstanceNotFoundException;
//##not compatible ### import javax.management.MBeanRegistrationException;
//##not compatible ### import javax.management.MBeanServer;
//##not compatible ### import javax.management.MalformedObjectNameException;
//##not compatible ### import javax.management.NotCompliantMBeanException;
//##not compatible ### import javax.management.ObjectName;
...
public abstract class BaseGenericObjectPool<T> {
    ...
    //##not compatible ### private final ObjectName oname;
    ...
    public BaseGenericObjectPool(BaseObjectPoolConfig config,
        ...
        if (config.getJmxEnabled()) {
        	//##not compatible ### this.oname = jmxRegister(config, jmxNameBase, jmxNamePrefix);
        } else {
        	//##not compatible ### this.oname = null;
        }
     ...
     * @return the JMX name
     */
   /*//##not compatible ###  public final ObjectName getJmxName() {
        return oname;
    }*/
